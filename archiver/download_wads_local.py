...
def move_files(dir: str,
               id: str,
               out_dir: str):
    rest = os.path.basename(dir)
    dest_dir = os.path.join(out_dir, f'{id}{rest}')
    os.makedirs(dest_dir, exist_ok=True)
    for entry in os.listdir(dir):
        src_path = os.path.join(dir, entry)
...
def download_and_process_zip(i: int, tmp_dir: str, out_dir: str):
    id = f"{i:02x}"
    tmp_dir = os.path.join(tmp_dir, id)
    extract_dir = os.path.join(tmp_dir, "extract")
    zip_path = os.path.join(tmp_dir, f"{id}.zip")
    ...
    if os.path.exists(done_path):
        ...
        return
    if os.path.exists(extract_dir):
        move_files(extract_dir, id=id, out_dir=out_dir)
...
def download_wad_archive(tmp_dir: str, out_dir: str):
    ...
    lock_dir_path = os.path.join(tmp_dir, "lock")
    ...
    for i in range(start_range, end_range+1):
        ...
        try:
            ...
            download_and_process_zip(i, tmp_dir, out_dir)
