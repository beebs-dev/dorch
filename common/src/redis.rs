...
pub mod topics {
    pub const IMAGE_WORK: &str = "image_work";
    pub const IMAGEGEN_WORK: &str = "imagegen_work";
    pub const TEXTGEN_WORK: &str = "textgen_work";
    pub const IMAGEGEN_UPLOADER_WORK: &str = "imagegen_uploader_work";
}
